                    ...
                    <c:forEach var="p" items="${products}">
                        <div class="swiper-slide">
                            <div class="product-card position-relative d-flex flex-column">
                                <div class="image-holder">
                                 <img src="${pageContext.request.contextPath}/images/${p.image}" alt="${p.title}" class="img-fluid">
                                </div>
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">$${p.priceSale}</span>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
...
<section id="mobile-products" class="product-store position-relative padding-large no-padding-top">
    <div class="container">
        <div class="row">
            ...
            <div class="swiper product-swiper">
                <div class="swiper-wrapper">
                    <c:forEach var="p" items="${products_macbook}">
                        <div class="swiper-slide">
                            <div class="product-card position-relative d-flex flex-column">
                                <div class="image-holder">
                                 <img src="${pageContext.request.contextPath}/images/${p.image}" alt="${p.title}" class="img-fluid">
          ...
          <div class="col-lg-4 col-sm-12 mb-4">
            <div class="card border-none me-3">
              <div class="card-image">
                <img src="images/${b.image}" alt="${b.title}" class="img-fluid">
              </div>
            </div>
            <div class="card-body text-uppercase">
              <div class="card-meta text-muted">
                <span class="meta-date">${b.createdDate}</span>
      ...
      <div class="review-content position-relative">
        ...
        <div class="swiper testimonial-swiper">
          <div class="quotation text-center">
            <svg class="quote"><use xlink:href="#quote" /></svg>
          </div>
          <div class="swiper-wrapper">
              ...
              <div class="swiper-slide text-center d-flex justify-content-center">
                <div class="review-item col-md-10">
                  ...
                  <div class="author-detail">
                    <div class="name text-dark text-uppercase pt-2">${c.name}</div>
                  </div>
                </div>
              </div>
            </c:forEach>
